...
$config['smtp_user'] 			= 'mailer.garagecoders@gmail.com'; 						// you@gmail.com
$config['smtp_pass'] 			= 'Gara63%Co034$';						// password
$config['smtp_ssl']				= false;					// should remain false

// Who receive all emails?
$config['send_to']				= 'mailer.garagecoders@gmail.com';	// destination of all emails sent throught contact form

// Email Subject
$config['subject']				= 'Iq4 Formulario de contacto';	// subject of emails you receive




/** ******************************************************* MISC ******************************************************* **/
define('UPLOAD_FOLDER',		'upload/');										// upload folder path - slash at the end!
define('UPLOAD_FOLDER_URL',	'http://iq4.com.mx/upload/');	// Full url path to upload folder (used for contact files) - slash at the end!
